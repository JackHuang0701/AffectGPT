...
#######################
PATH_TO_LLM = {
    'Qwen25': r"E:\HW\checkpoint\Qwen2.5-0.5B-Instruct",
}

PATH_TO_VISUAL = {
    'CLIP_VIT_LARGE': r"E:\HW\checkpoint\clip-vit-large-patch14",

}

PATH_TO_AUDIO = {
    'HUBERT_LARGE':  r"E:\HW\checkpoint\chinese-hubert-large",
}
